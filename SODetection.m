function out = SODetection(RecordingValues, SleepScoring, ScoringArtefacts, Label, fsample)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
MinSODur    = 0.4; %Parameters according to the values we detected (Histogram)
...
NegPkPerc = 36.9; % Value of events detected using mPFC_Left considering Mï¿½lle 2006 as reference.
...
Pk2PkPerc = 46.9; % Value of events detected using mPFC_Left considering Mï¿½lle 2006 as reference.
